...
class MemberConnect:
    def __init__(self,root):
        ...
        RecIDBar = StringVar()
        #=============================================================================================
        MainFrame = Frame(self.root, bd=10, width = 1350, height = 700, relief = RIDGE, bg="forestgreen")
        MainFrame.grid()
        ...
        TreeviewFrm = Frame(MidFrame, bd=5, width = 1340, height = 400, padx =2, relief = RIDGE)
        TreeviewFrm.grid(row = 1, column =0)

        ButtonFrame = Frame(MidFrame, bd=7, width =1340, height = 50, bg="forestgreen", relief = RIDGE)
        ButtonFrame.grid(row =2, column = 0)
        #============================================================================================
        self.lbTitle = Label(TitleFrames, font = ('arial', 40, 'bold'), text = "Infant Immunization Records Database", bd=7)
        self.lbTitle.grid(row = 0, column = 0, padx=176)
        #============================================================================================
        ...
        self.txtrecordID = Entry(MemberDetailsFrm, font = ('arial', 12, 'bold'), bd=5, width = 36, justify = LEFT, textvariable=RecID)
        ...
        self.txtChildname = Entry(MemberDetailsFrm, font=('arial', 12, 'bold'), bd=5, width = 36, justify = LEFT, textvariable = Childname)
        ...
        self.txtAge = Entry(MemberDetailsFrm, font=('arial', 12, 'bold'), bd=5, width = 36, justify = LEFT, textvariable = Age)
        ...
        self.txtVaccinetype = Entry(MemberDetailsFrm, font = ('arial', 12, 'bold'), bd=5, width = 40, justify = LEFT, textvariable=Vaccinetype)
        ...
        self.cboVaccinedose = ttk.Combobox(MemberDetailsFrm, font=('arial', 12, 'bold'), width = 38, state = 'readonly', textvariable =Vaccinedose)
        ...
        self.txtCheckfindings = Entry(MemberDetailsFrm, font=('arial', 12, 'bold'), bd=5, width = 40, textvariable = Checkfindings)
        ...
        self.txtCheckremarks  =Entry(MemberDetailsFrm, font = ('arial', 12, 'bold'), bd=5, width = 35, justify = LEFT, textvariable=Checkremarks)
        ...
        self.txtDoctor = Entry(MemberDetailsFrm, font=('arial', 12, 'bold'), bd=5, width = 35, textvariable = Doctor)
        ...
        self.txtLocation  =Entry(MemberDetailsFrm, font = ('arial', 12, 'bold'), bd=5, width = 35, justify = LEFT, textvariable=Location)
        ...
        self.member_records.column("age", width = 100)
        self.member_records.column("vaccinetype", width = 120)
        self.member_records.column("vaccinedose", width = 120)
        self.member_records.column("checkfindings", width = 212)
        self.member_records.column("checkremarks", width = 212)
        self.member_records.column("doctor", width = 165)
        self.member_records.column("location", width = 180)
        ...
        self.btnSearch = Button(SearchFrame, pady=1, padx=29, bd=4, font = ('arial', 16, 'bold'), width=9, height = 1, text ="Search", bg= "forestgreen", command=searchDG).grid(row = 0, column = 3,padx=1)
        #============================================================================================
